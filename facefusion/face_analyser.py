...
def get_many_faces(vision_frame: VisionFrame) -> List[Face]:
    ...
    try:
        ...
        if faces_cache:
            ...
            if facefusion.globals.face_detector_model in ['many', 'scrfd']:
                bounding_box_list_scrfd, face_landmark_5_list_scrfd, score_list_scrfd = detect_with_scrfd(vision_frame,
            ...
            if facefusion.globals.face_detector_model in ['yunet']:
                bounding_box_list_yunet, face_landmark_5_list_yunet, score_list_yunet = detect_with_yunet(vision_frame,
                                                                                                          facefusion.globals.face_detector_size)
