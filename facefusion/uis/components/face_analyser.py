...
def render() -> None:
    ...
    if facefusion.globals.face_detector_size in facefusion.choices.face_detector_set[
        ...
        face_detector_size_dropdown_args['choices'] = facefusion.choices.face_detector_set[
            facefusion.globals.face_detector_model]
    with gradio.Row():
...
def listen() -> None:
    ...
    FACE_DETECTOR_MODEL_DROPDOWN.change(update_face_detector_model, inputs=FACE_DETECTOR_MODEL_DROPDOWN,
                                        outputs=FACE_DETECTOR_SIZE_DROPDOWN)
...
def update_face_detector_model(face_detector_model: FaceDetectorModel) -> gradio.Dropdown:
    ...
    if facefusion.globals.face_detector_size in facefusion.choices.face_detector_set[face_detector_model]:
        return gradio.Dropdown(value=facefusion.globals.face_detector_size,
                               choices=facefusion.choices.face_detector_set[face_detector_model])
    return gradio.update(value=facefusion.globals.face_detector_size, choices=[facefusion.globals.face_detector_size])
