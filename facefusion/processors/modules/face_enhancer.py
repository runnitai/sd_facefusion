...
from facefusion import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, \
    face_recognizer, inference_manager, logger, state_manager, wording, process_manager
...
def register_args(program: ArgumentParser) -> None:
    ...
    if group_processors:
        ...
        group_processors.add_argument('--face-enhancer-blend', help=wording.get('help.face_enhancer_blend'), type=int,
