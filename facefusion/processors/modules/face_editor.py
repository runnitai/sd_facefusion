...
from facefusion import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, \
    face_recognizer, inference_manager, logger, process_manager, state_manager, wording
...
from facefusion.processors.typing import FaceEditorInputs, LivePortraitExpression, LivePortraitFeatureVolume, \
    LivePortraitMotionPoints, LivePortraitPitch, LivePortraitRoll, LivePortraitRotation, LivePortraitScale, \
    LivePortraitTranslation, LivePortraitYaw
from facefusion.program_helper import find_argument_group
from facefusion.thread_helper import conditional_thread_semaphore, thread_semaphore
from facefusion.typing import ApplyStateItem, Args, Face, FaceLandmark68, InferencePool, ModelOptions, ModelSet, \
    ProcessMode, QueuePayload, UpdateProgress, VisionFrame
...
def register_args(program: ArgumentParser) -> None:
    ...
    if group_processors:
        group_processors.add_argument('--face-editor-model', help=wording.get('help.face_editor_model'),
        ...
        group_processors.add_argument('--face-editor-eyebrow-direction',
                                      help=wording.get('help.face_editor_eyebrow_direction'), type=float,
        ...
        group_processors.add_argument('--face-editor-eye-gaze-horizontal',
                                      help=wording.get('help.face_editor_eye_gaze_horizontal'), type=float,
        ...
        group_processors.add_argument('--face-editor-eye-gaze-vertical',
                                      help=wording.get('help.face_editor_eye_gaze_vertical'), type=float,
        ...
        group_processors.add_argument('--face-editor-eye-open-ratio',
                                      help=wording.get('help.face_editor_eye_open_ratio'), type=float,
        ...
        group_processors.add_argument('--face-editor-lip-open-ratio',
                                      help=wording.get('help.face_editor_lip_open_ratio'), type=float,
        ...
        group_processors.add_argument('--face-editor-mouth-grim', help=wording.get('help.face_editor_mouth_grim'),
                                      type=float,
        ...
        group_processors.add_argument('--face-editor-mouth-pout', help=wording.get('help.face_editor_mouth_pout'),
                                      type=float,
        ...
        group_processors.add_argument('--face-editor-mouth-purse', help=wording.get('help.face_editor_mouth_purse'),
                                      type=float,
        ...
        group_processors.add_argument('--face-editor-mouth-smile', help=wording.get('help.face_editor_mouth_smile'),
                                      type=float,
        ...
        group_processors.add_argument('--face-editor-mouth-position-horizontal',
                                      help=wording.get('help.face_editor_mouth_position_horizontal'), type=float,
        ...
        group_processors.add_argument('--face-editor-mouth-position-vertical',
                                      help=wording.get('help.face_editor_mouth_position_vertical'), type=float,
        ...
        group_processors.add_argument('--face-editor-head-pitch', help=wording.get('help.face_editor_head_pitch'),
                                      type=float,
        ...
        group_processors.add_argument('--face-editor-head-yaw', help=wording.get('help.face_editor_head_yaw'),
                                      type=float,
        ...
        group_processors.add_argument('--face-editor-head-roll', help=wording.get('help.face_editor_head_roll'),
                                      type=float,
        ...
        facefusion.jobs.job_store.register_step_keys(
            ['face_editor_model', 'face_editor_eyebrow_direction', 'face_editor_eye_gaze_horizontal',
             ...
             'face_editor_mouth_grim', 'face_editor_mouth_pout', 'face_editor_mouth_purse', 'face_editor_mouth_smile',
             'face_editor_mouth_position_horizontal', 'face_editor_mouth_position_vertical', 'face_editor_head_pitch',
...
def edit_face(target_face: Face, temp_vision_frame: VisionFrame) -> VisionFrame:
    ...
    crop_vision_frame, affine_matrix = warp_face_by_face_landmark_5(temp_vision_frame, face_landmark_5, model_template,
                                                                    model_size)
...
def forward_extract_motion(crop_vision_frame: VisionFrame) -> Tuple[
...
def forward_stitch_motion_points(source_motion_points: LivePortraitMotionPoints,
...
def forward_generate_frame(feature_volume: LivePortraitFeatureVolume, source_motion_points: LivePortraitMotionPoints,
...
def edit_eye_open(motion_points: LivePortraitMotionPoints,
...
def edit_lip_open(motion_points: LivePortraitMotionPoints,
                  face_landmark_68: FaceLandmark68) -> LivePortraitMotionPoints:
