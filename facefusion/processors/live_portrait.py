...
from facefusion.processors.typing import LivePortraitExpression, LivePortraitPitch, LivePortraitRoll, \
    LivePortraitRotation, LivePortraitYaw
...
def limit_euler_angles(target_pitch: LivePortraitPitch, target_yaw: LivePortraitYaw, target_roll: LivePortraitRoll,
                       output_pitch: LivePortraitPitch, output_yaw: LivePortraitYaw, output_roll: LivePortraitRoll) -> \
Tuple[LivePortraitPitch, LivePortraitYaw, LivePortraitRoll]:
    pitch_min, pitch_max, yaw_min, yaw_max, roll_min, roll_max = calc_euler_limits(target_pitch, target_yaw,
                                                                                   target_roll)
...
def calc_euler_limits(pitch: LivePortraitPitch, yaw: LivePortraitYaw, roll: LivePortraitRoll) -> Tuple[
